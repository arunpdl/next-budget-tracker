        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              {type === "income" ? (
                <TrendingUp className="p-2 text-emerald-500 h-12 w-12 items-center rounded-lg bg-emerald-400/10" />
              ) : (
                <TrendingDown className="p-2 text-rose-500 h-12 w-12 items-center rounded-lg bg-rose-400/10" />
              )}
              <div>
